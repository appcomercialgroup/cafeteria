    ...
    <section class="tm-section row">
      <div class="col-lg-9 col-md-9 col-sm-8">
        ...
        <p class="tm-welcome-description">
          ...
          . Fndimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Ettiam sit amet orci eget eros faucibus tincidunt.
        </p>
        <a class="tm-more-button margin-top-30 " href="#">
          Read More
        </a>
      </div>
    ...
    <section class="tm-section tm-section-margin-bottom-0 row">
      ...
      <div class="col-lg-12 tm-popular-items-container">
        <div class="tm-popular-item">
          <img alt="Popular" class="tm-popular-item-img" src="img/popular-1.jpg"/>
          <div class="tm-popular-item-description">
            ...
            <hr class="tm-popular-item-hr">
              ...
              <div class="order-now-container">
                <a class="order-now-link tm-handwriting-font" href="#">
                  Order Now
                </a>
              </div>
            </hr>
        ...
        <div class="tm-popular-item">
          <img alt="Popular" class="tm-popular-item-img" src="img/popular-2.jpg"/>
          <div class="tm-popular-item-description">
            <h3 class="tm-handwriting-font tm-popular-item-title">
              <span class="tm-handwriting-font bigger-first-letter">
                c
        ...
        <div class="tm-popular-item">
          <img alt="Popular" class="tm-popular-item-img" src="img/popular-3.jpg"/>
          <div class="tm-popular-item-description">
            <h3 class="tm-handwriting-font tm-popular-item-title">
              <span class="tm-handwriting-font bigger-first-letter">
                m
      ...
      </div>    <div class="col-lg-12 tm-popular-items-container">
        <div class="tm-popular-item">
          <img alt="Popular" class="tm-popular-item-img" src="img/popular-1.jpg"/>
          <div class="tm-popular-item-description">
            <h3 class="tm-handwriting-font tm-popular-item-title">
