<div class="w3-modal mas_informacion w3-animate-zoom modal_sesion modal_inicio_sesion">
  <div class="w3-modal-content w3-card-4">
    <header class="w3-container bg_marron">
      ...
      <a class="tm-more-button w3-display-topright btn_cerar_modal_sesion" style="margin-top: 10px; margin-right: 10px;">
        Cerrar
      </a>
    ...
    <footer class="w3-container fondo_modal pie_modal w3-padding-16">
      <div class="row">
        <div class="w3-col s12 m6 l6">
          <a class="tm-more-button w3-left btn_inicio" href="#">
            Inicio
          </a>
        </div>
        <div class="w3-col s12 m6 l6">
          <a class="tm-more-button w3-right btn_registro" href="#">
            Registro
          </a>
        </div>
      </div>
